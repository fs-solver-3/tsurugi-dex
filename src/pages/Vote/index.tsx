              ...
              <AutoColumn gap="md">
                <RowBetween>
                  <TYPE.white fontWeight={600}>
                    <Trans>Tsurugi Governance</Trans>
                  </TYPE.white>
                </RowBetween>
                <RowBetween>
                  <TYPE.white fontSize={14}>
                    <Trans>
                      TRGX tokens represent voting shares in Tsurugi governance. You can vote on each proposal yourself
                ...
                <ExternalLink
                  ...
                  href="https://tsurugi-finance.org/"
                  target="_blank"
                >
                  <TYPE.white fontSize={14}>
                    <Trans>Read more about Tsurugi governance</Trans>
                  </TYPE.white>
                </ExternalLink>
              </AutoColumn>
            </CardSection>
